...
def calculate_kkt(a,**kwargs):
    ...
    dloss = np.log10(loss_fx) - np.log10(loss_vd)
    return dloss
...
# =============================================================================
    InPuT.auto_modifier("plastic_hinge",4.23)
    # ---------------------------------------------
    # validation dataset
    nums = [0,8]
    ...
    PMKkt.purge(adj = "max") # opt mode for power: Tikhonov
    ...
    # ==========================================================================
    # =========================== Part 2 : Calculate ===========================
    calculate_kkt(root, Mat=MatrixGen)
